...
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Yokito! Keybind ( E )", Text = "Enjoy !"})
...
local UIStroke = Instance.new("UIStroke")UIStroke.Color = Color3.fromRGB(100,0,100) UIStroke.Parent = FOVFFrame UIStroke.Thickness = 1 UIStroke.ApplyStrokeMode = "Border" game:GetService("StarterGui"):SetCore("SendNotification", {Title = "https://discord.gg/", Text = "Our Discord"})
